...
def was_referenced(references: list[AstNode], identifier: AstNode):
    ...
    for reference in references:
        ...
        if reference.location == identifier.location and reference.end_location == identifier.end_location:
            return True
...
def index_function_ast(ast: T, function_location: str, module: CompiledModule|None = None) -> T:
